...
if ($error_fechas == "") {
    ...
    $pdf->Cell(0, 5, "Teléfono: " . $datos_empresa['empresa_telefono'], 0, 1, 'C');
...
$pdf->Ln(5);
    ...
    $pdf->Cell(15, 8, 'N', 1, 0, 'C');
    $pdf->Cell(30, 8, 'Código', 1, 0, 'C');
    $pdf->Cell(50, 8, 'Cliente', 1, 0, 'C');
    $pdf->Cell(20, 8, 'Monto', 1, 0, 'C');
    $pdf->Cell(20, 8, 'Fecha', 1, 0, 'C');
    $pdf->Cell(25, 8, 'Banco', 1, 0, 'C');
    $pdf->Cell(35, 8, 'N° Operación', 1, 1, 'C'); // Aumentar el ancho de esta columna
